...
d1.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/sebastien-martin/1163913-11-fre-FR/Sebastien-Martin_profile_avatar.jpg')
...
d2 = User.new
d2.civility = "Mme"
d2.first_name = "Anne-Sophie"
d2.last_name = "FUERTES"
d2.email = "myriam.6c@gmail.com"
d2.password = "123456"
d2.password_confirmation = "123456"
d2.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/anne-sophie-fuertes/67311-69-fre-FR/Anne-Sophie-FUERTES_profile_avatar.jpg")
...
d3.is_pro = true
avatar_docteur_female_nurse = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/elisabeth-konrat/1117025-29-fre-FR/Elisabeth-KONRAT_profile_avatar.png')
...
d4.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/elsa-gruenfeld/1125366-13-fre-FR/Elsa-GRUeNFELD_profile_avatar.JPG")
...
d5.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/marion-fabre/1159312-7-fre-FR/Marion-FABRE_profile_avatar.jpg")
...
d6.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/nathalie-de-reynal/1124224-17-fre-FR/Nathalie-de-Reynal_profile_avatar.jpg")
...
d7 = User.new
d7.civility = "Mme"
d7.first_name = "Claudie"
d7.last_name = "de la Maisoneuve"
d7.email = "docteur7@gmail.com"
d7.password = "123456"
d7.password_confirmation = "123456"
d7.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/claudie-de-la-maisoneuve/1115065-7-fre-FR/Claudie-de-la-Maisoneuve_profile_avatar.jpg")
...
d8.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/amandine-caulle2/1166052-4-fre-FR/Amandine-Caulle_profile_avatar.jpg")
...
d9 = User.new
d9.civility = "Mme"
d9.first_name = "Virginie"
d9.last_name = "BAPT"
d9.email = "docteur9@gmail.com"
d9.password = "123456"
d9.password_confirmation = "123456"
d9.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/virginie-bapt/112823-19-fre-FR/virginie-BAPT_profile_avatar.JPG")
...
d10.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/colombe-alvarez/1154927-15-fre-FR/Colombe-Alvarez_profile_avatar.jpg")
...
d11.last_name = "BOUDARD"
d11.email = "docteur11@gmail.com"
d11.password = "123456"
d11.password_confirmation = "123456"
d11.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/romain-boudard/1117165-9-fre-FR/Romain-BOUDARD_profile_avatar.jpg')
...
d12 = User.new
d12.civility = "Mme"
d12.first_name = "Myriam"
d12.last_name = "CLAUSELLS"
d12.email = "docteur12@gmail.com"
d12.password = "123456"
d12.password_confirmation = "123456"
d12.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/myriam-clausells/1128672-7-fre-FR/Myriam-CLAUSELLS_profile_avatar.png")
...
d13.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/elisa-monnet/1163357-15-fre-FR/Elisa-Monnet_profile_avatar.jpg")
...
d14.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/fanny-debat/1113018-38-fre-FR/Fanny-DEBAT_profile_avatar.jpg")
...
d15.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/jean-cyrille-lecoq/1117359-22-fre-FR/Jean-Cyrille-Lecoq_profile_avatar.jpg')
...
d16 = User.new
d16.civility = "Mme"
d16.first_name = "Nathalie"
d16.last_name = "DUBOC"
d16.email = "docteur16@gmail.com"
d16.password = "123456"
d16.password_confirmation = "123456"
d16.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/nathalie-duboc/1055459-2-fre-FR/Nathalie-DUBOC_profile_avatar.png")
...
d17 = User.new
d17.civility = "Mme"
d17.first_name = "Marie"
d17.last_name = "Robin"
d17.email = "docteur17@gmail.com"
d17.password = "123456"
d17.password_confirmation = "123456"
d17.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/marie-robin/1062984-8-fre-FR/Marie-Robin_profile_avatar.jpg")
...
d18.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/melanie-bouxom/1157414-12-fre-FR/Melanie-Bouxom_profile_avatar.jpg")
...
d19.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/stephane-chaussin/1158074-6-fre-FR/Stephane-CHAUSSIN_profile_avatar.JPG')
...
d20.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/laurent-depraz/1087848-31-fre-FR/laurent-depraz_profile_avatar.jpg')
...
d21 = User.new
d21.civility = "M."
d21.first_name = "Bogdan"
d21.last_name = "VITAS BOGINO"
d21.email = "docteur21@gmail.com"
d21.password = "123456"
d21.password_confirmation = "123456"
d21.is_pro = true

avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/bogdan-vitas-bogino/1161954-5-fre-FR/Bogdan-VITAS-BOGINO_profile_avatar.jpg")
...
d22 = User.new
d22.civility = "M."
d22.first_name = "Jacques"
d22.last_name = "Sebbane"
d22.email = "docteur22@gmail.com"
d22.password = "123456"
d22.password_confirmation = "123456"
d22.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/jacques-sebbane/1092278-29-fre-FR/Jacques-Sebbane_profile_avatar.jpg')
...
d23 = User.new
d23.civility = "Mme"
d23.first_name = "Amélie"
d23.last_name = "Revel"
d23.email = "docteur23@gmail.com"
d23.password = "123456"
d23.password_confirmation = "123456"
d23.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/amelie-revel/1061838-13-fre-FR/Amelie-Revel_profile_avatar.png")
...
d24 = User.new
d24.civility = "Mme"
d24.first_name = "Elisabeth"
d24.last_name = "Lenkey"
d24.email = "docteur24@gmail.com"
d24.password = "123456"
d24.password_confirmation = "123456"
d24.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/elisabeth-lenkey/1099136-20-fre-FR/Elisabeth-Lenkey_profile_avatar.jpeg")
...
d25 = User.new
d25.civility = "Mme"
d25.first_name = "Elina"
d25.last_name = "LAJEVARDI"
d25.email = "docteur25@gmail.com"
d25.password = "123456"
d25.password_confirmation = "123456"
d25.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/elina-lajevardi/1041625-12-fre-FR/Elina-LAJEVARDI_profile_avatar.jpg")
...
d26 = User.new
d26.civility = "Mme"
d26.first_name = "Caroline"
d26.last_name = "DELAUNAY DIOT"
d26.email = "docteur26@gmail.com"
d26.password = "123456"
d26.password_confirmation = "123456"
d26.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/caroline-delaunay-diot/63036-37-fre-FR/Caroline-DELAUNAY-DIOT_profile_avatar.png')
...
d27 = User.new
d27.civility = "M."
d27.first_name = "Olivier"
d27.last_name = "COLOMBEL"
d27.email = "docteur27@gmail.com"
d27.password = "123456"
d27.password_confirmation = "123456"
d27.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/olivier-colombel/116432-26-fre-FR/Olivier-COLOMBEL_profile_avatar.png")
...
d28 = User.new
d28.civility = "Mme"
d28.first_name = "FREDERIQUE"
d28.last_name = "CAFFIER"
d28.email = "docteur28@gmail.com"
d28.password = "123456"
d28.password_confirmation = "123456"
d28.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/frederique-caffier/1167684-2-fre-FR/FREDERIQUE-CAFFIER_profile_avatar.JPG")
...
d28.phone = "0620845809"
d28.save!

d29 = User.new
d29.civility = "Mme"
d29.first_name = "Sandrine"
d29.last_name = "BREDECHE"
d29.email = "docteur29@gmail.com"
d29.password = "123456"
d29.password_confirmation = "123456"
d29.is_pro = true
avatar_docteur_female = Down.download("https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/sandrine-bredeche/1096030-18-fre-FR/Sandrine-BREDECHE_profile_avatar.JPG")
...
d30 = User.new
d30.civility = "M."
d30.first_name = "Stéphane"
d30.last_name = "Arnoux"
d30.email = "docteur30@gmail.com"
d30.password = "123456"
d30.password_confirmation = "123456"
d30.is_pro = true
avatar_docteur_male = Down.download('https://monpsy.psychologies.com/var/site/storage/images/le-1er-annuaire-de-reference-des-psys/psys/stephane-arnoux/1122046-16-fre-FR/Stephane-Arnoux_profile_avatar.jpg')
...
d31.is_pro = true
avatar_docteur_male = Down.download('https://cdn-s-www.leprogres.fr/images/8DCDA839-102A-47A2-9EDB-131571C78A20/NW_detail/title-1360592481.jpg')
...
activity1.user = d1
activity1.speciality_id = s5.id
activity1.office_id = office1.id
activity1.save!

activity2 = Activity.new
activity2.user = d2
activity2.speciality_id = s5.id
activity2.office_id = office2.id
activity2.save!

activity3 = Activity.new
activity3.user = d3
activity3.speciality_id = s5.id
...
activity6.user = d6
activity6.speciality_id = s5.id
activity6.office_id = office5.id
activity6.save!

activity7 = Activity.new
activity7.user = d7
activity7.speciality_id = s10.id
...
activity25.user = d25
activity25.speciality_id = s10.id
